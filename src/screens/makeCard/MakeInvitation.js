...
export default class MakeInvitation extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            show: false,
            opacity: 1,
            xPos: CardConfig.defaultInvitationTextPosition.xPos,
            ...
            switch (templateType) {
                ...
                default:
                    this.setState({
                        ...
                        input5Text: '',
                        input6Text: '',
                        yPos1: CardConfig.defaultInvitationTextPosition.yPos1,
                        yPos2: CardConfig.defaultInvitationTextPosition.yPos2,
                        yPos3: CardConfig.defaultInvitationTextPosition.yPos3,
                        yPos4: CardConfig.defaultInvitationTextPosition.yPos4,
                        yPos5: CardConfig.defaultInvitationTextPosition.yPos5,
                        yPos6: CardConfig.defaultInvitationTextPosition.yPos6,
                        yPos7: CardConfig.defaultInvitationTextPosition.yPos7,
