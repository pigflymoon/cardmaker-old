export default {
    ...
    screens: {
        exploreTranslation: '首頁',
        imagesGalleryTranslation: '圖庫',
        cardsDeckTranslation: '刷一刷',
        myFavoritesTranslation: '我喜歡的卡片',
        makeCardTranslation: '製作卡片',
        makeInvitationTranslation: '製作邀請函',
        welcomeTranslation: '歡迎',
        confirmEmailTranslation: '確認郵箱',
        resetPasswordTranslation: '重設密碼',
        termsTranslation: '服務協議',
        policyTranslation: '隱私保護',
        aboutTranslation: '關於',
    },
    exploreTab: {
    ...
    settingsTab:{
        ...
        restorePurchaseTraslation:'恢復購買',
        proVersionTranslation:'付費版本',
        rateTranslation:'給App Store上評分',
        tellFriendTranslation:'分享給朋友',
        notificationTranslation:'通知',
        aboutTranslation:'關於',
        instagramTranslation:'Instagram',
        findArtistTranslation:'畫家Instagram',
